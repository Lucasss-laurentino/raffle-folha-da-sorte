...
export const Outlet_minha_conta = () => {
    ...
    return (
        ...
        <>
            <h6 className='pt-5 w-100 text-center text-alt'>Faça alterações em sua conta</h6>
            ...
            <div className="div-inputs">
                ...
                <div className="row justify-content-center">
                    <div className="container pb-3">
                        <div className="position-relative d-flex justify-content-center">
                            <div className="position-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="29" height="19" fill="#9e9e9e" className="bi bi-key-fill" viewBox="0 0 16 16">
